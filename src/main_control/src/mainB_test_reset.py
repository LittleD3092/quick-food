...
if __name__ == '__main__': # main for B field.
	...
	BOWLING_GOAL_COOR = ((-324, 63, 180, True),
				         (-283, 63, 180, True), 
				         (-241, 63, 180, True),
				         (-199, 63, 180, True),
				         (-157, 63, 180, True),
	...
	baseNode.move((170, 0, 270, False))
	baseNode.move((170, -425, 270, True))
	baseNode.move((72, -425, 270, True))
	...
	baseNode.move((170, -425, 270, False))
	baseNode.move((170, 0, 270, False))
