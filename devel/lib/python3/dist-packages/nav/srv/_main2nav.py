...
"""autogenerated by genpy from nav/main2navRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_3h():
    ...
    return _struct_3h
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from nav/main2navResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class main2navResponse(genpy.Message):
  ...
  _type = "nav/main2navResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool done_flag
