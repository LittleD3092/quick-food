...
(cl:defmethod cl:initialize-instance :after ((m <main2nav-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'main2nav-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nav-srv:<main2nav-request> is deprecated: use nav-srv:main2nav-request instead.")))

(cl:ensure-generic-function 'main_x-val :lambda-list '(m))
(cl:defmethod main_x-val ((m <main2nav-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav-srv:main_x-val is deprecated.  Use nav-srv:main_x instead.")
  (main_x m))

(cl:ensure-generic-function 'main_y-val :lambda-list '(m))
(cl:defmethod main_y-val ((m <main2nav-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav-srv:main_y-val is deprecated.  Use nav-srv:main_y instead.")
  (main_y m))
...
(cl:defmethod cl:initialize-instance :after ((m <main2nav-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'main2nav-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nav-srv:<main2nav-response> is deprecated: use nav-srv:main2nav-response instead.")))

(cl:ensure-generic-function 'done_flag-val :lambda-list '(m))
(cl:defmethod done_flag-val ((m <main2nav-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nav-srv:done_flag-val is deprecated.  Use nav-srv:done_flag instead.")
  (done_flag m))
